...
START:
	...
	CMA
	CPI 04H		; compare immediate with 40H (continuing condition)
	JZ CONT
	ANI 40H		; logical and 04H with content of A 
	CPI 40H		; 04H is ending condition 
	JZ END	
	JMP START
CONT:
	MOV A,B
	...
	CMA
	ANI 0CH
	CPI 0CH		;60H is pause condition
	JZ START	
	IN 01H
	CMA
	ANI 40H
